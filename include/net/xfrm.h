...
extern void xfrm4_protocol_init(void);
#ifdef CONFIG_XFRM
...
extern int xfrm6_mode_tunnel_input_register(struct xfrm_tunnel_notifier *handler);
extern int xfrm6_mode_tunnel_input_deregister(struct xfrm_tunnel_notifier *handler);
